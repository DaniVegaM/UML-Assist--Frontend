...
${edges
    ...
    return (
        <>
            <button onClick={() => setIsVisible(prev => !prev)} className="fixed bottom-38 right-2 bg-sky-600 p-2 rounded-full cursor-pointer shadow-lg hover:bg-sky-700 transition-colors z-50 border-1 border-zinc-400">
