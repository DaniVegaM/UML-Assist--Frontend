...
const BreakFragmentNode = ({ id, data, selected }: NodeProps) => {
  ...
  const { getNodesBounds, getInternalNode } = useReactFlow();
  ...
  return (
    ...
    <div className="absolute inset-0 z-20 pointer-events-none">
      ...
      {(data as any)?.suggestion && (
        <>
          <button
            ...
            className="ver-ia absolute -top-6 -right-6 z-20 w-5 h-5 rounded-full bg-sky-500 hover:bg-sky-600 text-white text-xs font-bold flex items-center justify-center shadow-md transition-colors cursor-pointer"
      ...
      <div className="flex items-start relative z-10">
        <div
          className="bg-gray-800 dark:bg-neutral-200 text-white dark:text-neutral-800 font-mono font-bold text-xs px-3 py-1 flex items-center justify-center relative z-10 pointer-events-auto nodrag"
          style={{
