                                ...
                                <div className="relative w-8 h-8 flex justify-center items-center"
                                    ...
                                    {handle.id.includes('defaultHandle') ? (
                                        ...
                                        <div className="cursor-pointer rounded-full w-12 h-12 absolute top-1/2 -left-1/4">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="black" className="w-full h-full stroke-black dark:stroke-neutral-400">
