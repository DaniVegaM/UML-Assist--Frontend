...
const BaseFragment = ({ selected }: NodeProps) => {
    ...
    return (
        ...
        >
            ...
            />
            <div
                className="bg-gray-300 dark:bg-neutral-800 w-[70px] h-[25px] px-1"
                style={{
            ...
            <div onDoubleClick={onFirstOperandDoubleClick}>
                <textarea
                    ...
                    className={`no-wheel nodrag w-full h-full placeholder-gray-400 bg-none dark:text-white border border-none outline-none resize-none text-center text-sm px-2 py-1 overflow-hidden ${isEditingFirstOperand ? 'pointer-events-auto' : 'pointer-events-none'}`}
                    rows={1}
                    ...
                    return (
                        ...
                        >
                            ...
                            <textarea
                                ...
                                placeholder={`[condición]`}
                                className={`no-wheel nodrag w-full placeholder-gray-400 bg-transparent dark:text-white border-none outline-none resize-none text-center text-sm px-2 py-1 overflow-hidden 
...
export default memo(BaseFragment);